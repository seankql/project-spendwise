...
export default function TransactionsController() {
  async function getTransactionsUseCase(userId, page, pageSize, token) {
    return fetch(
      "https://api.spendw.cscc09.rocks/api/transactions?" +
        new URLSearchParams({
          userId: userId,
          page: page,
          pageSize: pageSize,
  ...
  async function createTransactionsUseCase(
    ...
    return fetch("https://api.spendw.cscc09.rocks/api/transactions", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
  ...
  async function updateTransactionsUseCase(
    ...
    return fetch(
      "https://api.spendw.cscc09.rocks/api/transactions/" + transactionId,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  async function getFilterTransactionsUseCase(
    ...
    return fetch(
      "https://api.spendw.cscc09.rocks/api/transactions/filters/" +
        userId +
        "/transactions?" +
        searchParams,
      {
